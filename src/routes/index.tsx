...
function Home() {
    ...
    return (
      <section className="relative overflow-hidden ink-panel">
        <div className="absolute inset-0">
          <img src={asset("/images/hero-plane.jpg")} alt="Cargo aircraft above clouds at golden hour" className="h-full w-full object-cover opacity-45" width={1920} height={1280} />
  ...
  function ServicesShowcase() {
    const svc = [
      { icon: Plane,     img: asset("/images/air-freight.jpg"),  key: "air"       },
      { icon: Ship,      img: asset("/images/sea-freight.jpg"),  key: "sea"       },
      { icon: Truck,     img: asset("/images/road-freight.jpg"), key: "road"      },
      { icon: Zap,       img: asset("/images/courier.jpg"),      key: "express"   },
      { icon: Warehouse, img: asset("/images/warehouse.jpg"),    key: "warehouse" },
      { icon: FileCheck2,img: asset("/images/containers.jpg"),   key: "customs"   },
    ] as const;
    return (
  ...
  function NetworkBand() {
    return (
      <section className="relative overflow-hidden ink-panel">
        <img src={asset("/images/network.jpg")} alt="Global logistics network arcs over an illuminated globe" className="absolute inset-0 h-full w-full object-cover opacity-40" loading="lazy" width={1600} height={900} />
      ...
      <section className="container-page pb-24">
        <div className="grid gap-6 lg:grid-cols-3">
          <div className="relative overflow-hidden rounded-3xl lg:col-span-2 aspect-[16/10]">
            <img src={asset("/images/control-room.jpg")} alt="Global operations control room with world route map" className="h-full w-full object-cover" loading="lazy" width={1600} height={1000} />
          ...
          <div className="relative overflow-hidden rounded-3xl aspect-[3/4] lg:aspect-auto">
            <img src={asset("/images/containers.jpg")} alt="Yellow shipping containers stacked at port" className="h-full w-full object-cover" loading="lazy" width={1280} height={1600} />
            <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/85 to-transparent p-8 text-white">
